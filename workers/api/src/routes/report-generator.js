...
const REPORT_HELPER_FILENAME = 'SkillCascadeReportHelper-release-20260610-house-style-goals-v4.zip'
const REPORT_HELPER_OBJECT_KEY = `report-generator/${REPORT_HELPER_FILENAME}`
const REPORT_HELPER_VERSION = 'release-20260610-house-style-goals-v4'
