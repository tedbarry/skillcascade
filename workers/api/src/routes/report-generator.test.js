...
describe('report-generator route contract', () => {
  ...
  it('returns local-helper module contract with reports.view', async () => {
    ...
    expect(payload.data.localHelper.pickFileEndpoint).toBe('/api/local-report-generator/pick-file')
  ...
  it('downloads the protected helper package as a zip', async () => {
    ...
    expect(response.headers.get('x-skillcascade-report-helper-version')).toBe('release-20260605-output-guard')
