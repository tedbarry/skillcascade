      ...
      {show && (
        ...
        >
          <div className="bg-[#1a2420] border border-[#2a3f35] rounded-lg px-4 py-3 flex items-start gap-3">
            ...
            <button
              onClick={onDismiss}
              className="text-[10px] font-medium text-[#10B981] hover:text-[#9fd5a8] bg-[#223d2e] hover:bg-[#2a4f38] rounded px-2.5 py-1.5 min-h-[44px] min-w-[44px] flex items-center justify-center shrink-0 transition-colors"
            >
              Got it
            </button>
          </div>
