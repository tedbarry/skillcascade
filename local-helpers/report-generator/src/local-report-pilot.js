...
export const SUPERVISOR_REVIEWED_REPORT_STYLE = {
  ...
  writingRules: [
    ...
    'For high-hour requests, describe emotional reactivity and maladaptive behavior with source-supported observable topographies and clinical impact, not vague labels alone.',
    'Avoid ADL, hygiene, toothbrushing, showering, or self-care wording unless explicitly needed; prefer daily-routine/routine-participation language when payer-sensitive.',
    'When more than 25 direct-care hours are requested, use comprehensive ABA treatment language and remove contradictory focused-treatment language.',
    'Do not include 97154, group-care rows, or social-skills group sections unless group service is actually requested.',
    'Parent involvement sections must be complete and must not retain placeholders such as mild/moderate/advanced, There are/are not barriers, or # hours per month.',
    'BIP FERB rows should use exact replacement-behavior objective wording when practical, and BIP baselines should list all behavior-reduction targets with their frequencies.',
    'Transition criteria must be measurable with count/frequency, timeframe, and accuracy/generalization criteria.',
